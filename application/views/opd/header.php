    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                <a class="nav-link active" href="<?= base_url('opd/') ?>">Dashboard <span class="sr-only">(current)</span></a>
                <a class="nav-link" href="<?= base_url('opd/input/') ?>">Input Program</a>
                <a class="nav-link" href="<?= base_url('opd/output/') ?>">Output</a>
            </div>
        </div>
