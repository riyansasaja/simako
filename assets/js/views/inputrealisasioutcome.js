$(document).ready(function () {
        ...
        "columns": [
            ...
            { "data": "outcome_program" },
            {
                ...
                "render": function (data, type, row) {
                    if (row.realisasi >= 1) {
                        return `<a href="javascript:;" class="item_edit badge badge-pill badge-warning">Edit</i></a>`;
                    } else {
                        return `<a href="javascript:;" class="item_edit badge badge-pill badge-primary">Input</i></a>`;
                    }
                }
            }
        ]
    ...
    let show_realisasi_outcome = $('#show_realisasi_outcome').DataTable({
        ...
        "columns": [
            ...
            {
                "data": null,
                "defaultContent": `<a href="javascript:;" id='deleteprogram' class="item_delete badge badge-pill badge-danger">Delete</a>`
            }
        ]
    });
